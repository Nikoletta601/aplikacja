...
public final class ActivityTasksViewBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public static ActivityTasksViewBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityTasksViewBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_tasks_view, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityTasksViewBinding bind(@NonNull View rootView) {
